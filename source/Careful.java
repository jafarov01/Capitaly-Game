...
public class Careful extends Player {
    ...
    public String toString()
    {
        ...
        sb.append("Careful:").append(System.lineSeparator());
        ...
        switch (f) {
            case Property property -> {
                ...
                if (!property.isSoldProperty()) {
                    if (money >= property.getPropertyPrice() * 2) //the player has money twice the property price amount to buy the property
                    {
                    ...
                    if (money >= property.getHousePrice() * 2) //the player has money twice the house price amount to buy a house
                    {
